...
public final class FragmentMenuBinding implements ViewBinding {
  ...
  private FragmentMenuBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView rvMenuList) {
    this.rootView = rootView;
    this.rvMenuList = rvMenuList;
  }
  ...
  public static FragmentMenuBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.rv_menu_list;
      RecyclerView rvMenuList = rootView.findViewById(id);
      if (rvMenuList == null) {
        break missingId;
      }

      return new FragmentMenuBinding((FrameLayout) rootView, rvMenuList);
    }
