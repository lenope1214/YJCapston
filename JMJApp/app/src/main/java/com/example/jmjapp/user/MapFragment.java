...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    @Override
    public void onDestroyView() { // Fragment와 관련된 View가 제거되는 단계
        super.onDestroyView();
        if(mFusedLocationProviderClient != null) {
    ...
    @Override
    public void onDestroy() { // Destroy 할 때는, 반대로 OnDestroyView에서 View를 제거하고, OnDestroy()를 호출한다.
        super.onDestroy();
        mapView.onDestroy();
    }
    ...
    private void setDefaultLocation() {
        ...
        markerOptions.snippet("위치 퍼미션과 GPS활성 여부 확인하세요.");
    ...
    String getCuurentAddress(LatLng latlng) {
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if(locationList.size() > 0) {
                ...
                String markerTitle = getCuurentAddress(currentPosition);
