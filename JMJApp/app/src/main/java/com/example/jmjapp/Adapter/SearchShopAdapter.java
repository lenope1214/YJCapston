...
public class SearchShopAdapter extends RecyclerView.Adapter<SearchShopAdapter.ItemViewHolder> {
    Context context;
    ArrayList<Shop> mItems;

    public SearchShopAdapter(Context context, ArrayList<Shop> shopss) {
    ...
    // 새로운 뷰 홀더 생성
    @Override
    public SearchShopAdapter.ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.restaurant_item_view, parent, false);
        return new SearchShopAdapter.ItemViewHolder(view);
    }
