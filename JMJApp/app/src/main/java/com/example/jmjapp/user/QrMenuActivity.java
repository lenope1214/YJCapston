...
public class QrMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.qrOrderBasket.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if(list_size == 0) {
                    ...
                    Toast.makeText(QrMenuActivity.this, "장바구니", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(QrMenuActivity.this, BasketActivity.class);
