...
import com.example.jmjapplication2.Fragment.ApiService;
import com.example.jmjapplication2.R;
import com.example.jmjapplication2.dto.Menu;
import com.example.jmjapplication2.owner.MenuDetailActivity;
...
public class MenuListRecyclerAdapter extends RecyclerView.Adapter<MenuListRecyclerAdapter.ItemViewHolder>{
    ...
    public void onBindViewHolder(final ItemViewHolder holder, final int position) {
        ...
        Glide.with(context).load(mItems.get(position).getImgUrl()).into(holder.shop_menu_img);
